...
export default function AboutPage() {
  ...
  return <main id="main" tabIndex={-1} className={`about-page ${staticMode ? 'about-static' : ''}`}>
    <div className="about-heading"><div><span className="small-label">About the artist</span><h1>A life in painting.</h1></div><p>Seven chapters.<br />A practice still unfolding.</p></div>
