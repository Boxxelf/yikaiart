...
for (const route of ['works', 'about']) { await fs.mkdir(`dist/${route}`, {recursive:true}); await fs.writeFile(`dist/${route}/index.html`, html); }
...
console.log('Prepared Works/About deep links, GitHub Pages fallback, and accessible text biography.');
